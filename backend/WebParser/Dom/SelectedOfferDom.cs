...
{
    class SelectedOfferDom : OfferDom
    {
        public static OfferDom Instance = new SelectedOfferDom();

        private SelectedOfferDom()
        {
            ...
            CompanyName = "div.row-layout.row-wrap.card-selected.card-current-cursor > div.contact-section.truncate > a > span.contact-link";
            CompanyContact = "div.row-layout.row-wrap.card-selected.card-current-cursor > div.contact-section.truncate > div > a";
            Age = "div.row-layout.row-wrap.card-selected.card-current-cursor > div.age-section > div.lower-cell.age-cell > div > div";
        }
    }
}
